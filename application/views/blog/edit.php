...
<main class="flex-1 ml-64 p-6 bg-gray-50">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
            <div>
                <h1 class="text-xl font-bold text-gray-800">Edit Artikel</h1>
                <p class="text-gray-500 text-sm mt-1">Perbarui konten artikel blog</p>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-sm overflow-hidden">
            <div class="p-6">
                <form action="<?= base_url('blog/update/' . $post->id); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="mb-6">
                                ...
                                <textarea name="content" id="content" rows="15" required
                                    class="w-full rounded-lg border border-gray-300 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                                    placeholder="Tulis konten artikel di sini..."><?= $post->content ?></textarea>
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <textarea name="excerpt" id="excerpt" rows="3"
                                    class="w-full rounded-lg border border-gray-300 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                                    placeholder="Ringkasan singkat artikel..."><?= $post->excerpt ?></textarea>
                                ...
                                <div class="mb-4">
                                    <div class="mb-2 w-full aspect-video bg-gray-100 rounded-lg flex items-center justify-center overflow-hidden">
                                        <?php if ($post->featured_image): ?>
                                            <img id="imagePreview" src="<?= base_url($post->featured_image) ?>" alt="<?= $post->title ?>" class="w-full h-full object-cover">
                                            <div id="placeholderText" class="text-gray-400 flex flex-col items-center hidden">
                                    ...
                                    <?php if ($post->featured_image): ?>
                                        <div class="mt-2 text-xs text-gray-500">
                                            <span>Gambar saat ini: <?= basename($post->featured_image) ?></span>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
